                ...
                <div class="col-lg-8 col-12">
                    <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true"
                        ...
                        <div class="scrollspy-example-item" id="item-2">
                            ...
                            <p class="text-justify indent-left">ภายในห้องศูนย์ข้อมูลข่าวสารจะรวบรวมเอกสารและข้อมูลที่เกี่ยวข้องกับการดำเนินงานของหน่วยงานตามที่กฎหมายกำหนด เช่น ข้อมูลงบประมาณ แผนงาน ผลการดำเนินงาน และกฎระเบียบต่าง ๆ เพื่อส่งเสริมความโปร่งใสและเปิดโอกาสให้ประชาชนร่วมตรวจสอบการทำงานของภาครัฐได้อย่างมีส่วนร่วม</p>
                            <div class="row">
                        ...
                        <div class="scrollspy-example-item" id="item-5">
                            ...
                            <p class="text-justify indent-left">เทศบาลนครพิษณุโลกเป็นองค์กรปกครองส่วนท้องถิ่นขนาดใหญ่ตั้งอยู่ในเขตอำเภอเมืองจังหวัดพิษณุโลกมีพื้นที่ 18.26 ตารางกิโลเมตร อยู่ในบริเวณภาคเหนือตอนล่างของประเทศไทยตามแนวละติจูดที่ 16 องศาเหนือ 16 ลิปดาตะวันออกและอยู่ห่างจากกรุงเทพมหานครไปทางทิศเหนือประมาณ 377 กิโลเมตร โดยมีอาณาเขตติดต่อกับพื้นที่ใกล้เคียงดังนี้:ทิศเหนือติดต่อเทศบาลตำบลหัวรอและเทศบาลเมืองอรัญญิกทิศใต้ติดต่อเทศบาลตำบลท่าทองและองค์การบริหารส่วนตำบลบึงพระ ทิศตะวันออกติดต่อเทศบาลเมืองอรัญญิก และทิศตะวันตกติดต่อเทศบาลตำบลบ้านคลองและองค์การบริหารส่วนตำบลวัดจันทร์</p>
        ...
        <a href="https://phsmun.go.th/organization" target="_blank" rel="nofollow">
            (คลิกเพื่อดูโครงสร้างองค์กร)
                        ...
                        <div class="scrollspy-example-item" id="item-7">
                            ...
                            <p class="text-justify indent-left">ประกอบด้วยแผนยุทธศาสตร์ แผนพัฒนาท้องถิ่น แผนการดำเนินงาน การติดตามและประเมินผลแผนพัฒนา แผนการบริหารจัดการความเสี่ยง งบประมาณรายจ่าย แผนอัตรากำลัง 3 ปี แผนปฏิบัติการป้องกันการทุจริต เทศบัญญัติรายจ่ายประจำปี การติดตามประเมินผล และรายงานผลต่าง ๆ</p>      
                            <blockquote class="blockquote">
