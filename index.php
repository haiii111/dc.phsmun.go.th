            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    <div class="book-section-info">
                        ...
                        <p class="text-justify">ทำความรู้จักกับศูนย์ข้อมูลข่าวสารตามพระราชบัญญัติข้อมูลข่าวสารของราชการ พ.ศ.2540 <a rel="nofollow" href="https://www.oic.go.th/act/Tatal_act2540_170853.pdf" target="_blank">(พ.ร.บ.)</a> กำหนดให้หน่วยงานของรัฐต้องจัดให้มีข้อมูลข่าวสารอย่างน้อยตามที่กฎหมายกำหนดไว้เพื่อให้ประชาชนสามารถเข้าตรวจสอบได้ โดยข้อมูลข่าวสารนี้จะต้องจัดเตรียมและจัดเก็บ ณ ที่ทำการของหน่วยงานที่เรียกว่าศูนย์ข้อมูลข่าวสารเพื่ออำนวยความสะดวกในการเข้าถึงข้อมูลของประชาชน</p>
                    </div>
                </div>
            </div>
        </div>
