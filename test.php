...
<body>
    <nav class="navbar navbar-expand-lg hero-navbar">
        <div class="container">
            <a class="navbar-brand" href="https://phsmun.go.th/frontpage">
    ...
    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
        <video autoplay muted loop class="hero-video">
            <source src="video/เทศบาล.mp4" type="video/mp4">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    <div class="book-section-info">
                        ...
                        <p class="text-justify">ทำความรู้จักกับศูนย์ข้อมูลข่าวสารตามพระราชบัญญัติข้อมูลข่าวสารของราชการ พ.ศ.2540 <a rel="nofollow" href="https://www.dla.go.th/upload/service/2554/6/21.pdf" target="_blank">(พ.ร.บ.)</a> กำหนดให้หน่วยงานของรัฐต้องจัดให้มีข้อมูลข่าวสารอย่างน้อยตามที่กฎหมายกำหนดไว้เพื่อให้ประชาชนสามารถเข้าตรวจสอบได้ โดยข้อมูลข่าวสารนี้จะต้องจัดเตรียมและจัดเก็บ ณ ที่ทำการของหน่วยงานที่เรียกว่าศูนย์ข้อมูลข่าวสารเพื่ออำนวยความสะดวกในการเข้าถึงข้อมูลของประชาชน</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-12">
                    <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true"
                        ...
                        <div class="scrollspy-example-item" id="item-1">
                            ...
                            <img src="images/Post.png" style="display: block; margin-left: auto; margin-right: auto;">
                        ...
                        <div class="scrollspy-example-item" id="item-2">
                            ...
                            <p class="text-justify"> ภายในห้องศูนย์ข้อมูลข่าวสารนี้จะมีเอกสารและข้อมูลที่เกี่ยวข้องกับการทำงานของหน่วยงานนั้น ๆ      ตามที่กฎหมายกำหนด เช่น ข้อมูลเกี่ยวกับงบประมาณ แผนงาน ผลการดำเนินงาน กฎระเบียบต่าง ๆ เป็นต้น เพื่อส่งเสริมความโปร่งใสและให้ประชาชนมีส่วนร่วมในการตรวจสอบข้อมูลของทางราชการ</p>
                            <div class="row">
                        ...
                        <div class="scrollspy-example-item" id="item-3">
                            ...
                            <p class="text-justify"> เป็นพื้นที่ที่จัดไว้ในห้องศูนย์ข้อมูลข่าวสารของหน่วยงานรัฐเพื่อให้ประชาชนสามารถนั่งอ่านเอกสารและข้อมูลต่างๆที่จัดเตรียมไว้ได้อย่างสะดวก มุมนี้จะมีการจัดโต๊ะ เก้าอี้และสิ่งอำนวยความสะดวกอื่น ๆ     ที่ช่วยให้ผู้เข้ามาใช้งานสามารถอ่านและศึกษาข้อมูลได้อย่างมีสมาธิและสะดวกสบาย</p>
                        ...
                        <div class="scrollspy-example-item" id="item-5">
                            ...
                            <p class="text-justify">ขนาดและที่ตั้งเทศบาลนครพิษณุโลกเป็นองค์กรปกครองส่วนท้องถิ่นขนาดใหญ่ตั้งอยู่ในเขตอำเภอเมืองพิษณุโลก จังหวัดพิษณุโลก มีพื้นที่ 18.26 ตารางกิโลเมตร ตั้งอยู่ในบริเวณภาคเหนือตอนล่างของประเทศไทย ตามแนวละติจูดที่ 16 องศาเหนือ 16 ลิปดาตะวันออก ห่างจากรุงเทพมหานคร ไปทางทิศเหนือประมาณ 377 กิโลเมตร มีอาณาเขตติดต่อกับพื้นที่ใกล้เคียง ดังนี้
                                ทิศเหนือติดต่อกับเทศบาลตำบลหัวรอและเทศบาลเมืองอรัญญิก
            ...
            <div class="container news-section">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="https://phsmun.go.th/frontpage" class="news-link" target="_blank">
                            <div class="news-item">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="https://phsmun.go.th/contactus/location" class="news-link" target="_blank">
                            <div class="news-item">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="https://phsmun.go.th/success6/detail/6/data.html" class="news-link"
                            target="_blank">
                            <div class="news-item">
